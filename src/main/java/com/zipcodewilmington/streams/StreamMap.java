...
public class StreamMap {
    ...
    public static Stream<String> letters(String someWord) {
        return someWord.chars().mapToObj(c -> String.valueOf((char)c));
        //or?: return Arrays.stream(someWord.split(""));
    }
    ...
    public static Stream<Stream<String>> wordsMap(String... someWords) {
        return Arrays.stream(someWords).map(w -> Arrays.stream(w.split("")));
        //does this work tho?
    }
